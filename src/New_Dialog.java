...
class New_Dialog extends JDialog {
	private New_Dialog dialog;
	
	public New_Dialog(MyCanvas cv) {
		super();

		dialog = this;
		
		System.out.println("새창뜸 ㅋ");
		...
		SpinnerModel x_sm = new SpinnerNumberModel(1, 1, 1500, 1);
		SpinnerModel y_sm = new SpinnerNumberModel(1, 1, 900, 1);
